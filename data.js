/*  Auto-generated by fetch_data.py — May 15, 2026 19:40
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7426.08, change: -1.0, ytd: 8.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29230.39, change: -1.18, ytd: 16.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49602.62, change: -0.92, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2800.23, change: -2.2, ytd: 11.6 },
  { ticker: "VIX", name: "Volatility", value: 18.02, change: 4.4, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.6, change: 3.0, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 18.0 },
  { name: "Healthcare", color: "#34d399", return30d: -1.8 },
  { name: "Financials", color: "#fbbf24", return30d: -2.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -1.3 },
  ...
  { name: "Software", color: "#e879f9", return30d: 10.9 },
