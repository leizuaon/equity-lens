/*  Auto-generated by fetch_data.py — April 13, 2026 19:16
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 6856.21, change: 0.58, ytd: -0.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 25274.77, change: 0.63, ytd: 0.3 },
  { ticker: "DJI", name: "Dow Jones", value: 48035.77, change: 0.25, ytd: -0.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2661.81, change: 1.19, ytd: 6.1 },
  { ticker: "VIX", name: "Volatility", value: 19.37, change: 0.73, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.3, change: -0.46, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 6.1 },
  { name: "Healthcare", color: "#34d399", return30d: -1.1 },
  { name: "Financials", color: "#fbbf24", return30d: 5.7 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 2.4 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 14.0 },
  { name: "Software", color: "#e879f9", return30d: -7.1 },
];
