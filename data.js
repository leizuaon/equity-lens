/*  Auto-generated by fetch_data.py — April 28, 2026 16:08
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7127.58, change: -0.65, ytd: 3.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26946.82, change: -1.31, ytd: 6.9 },
  { ticker: "DJI", name: "Dow Jones", value: 49262.88, change: 0.19, ytd: 1.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2751.5, change: -1.32, ytd: 9.7 },
  { ticker: "VIX", name: "Volatility", value: 18.66, change: 3.55, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.36, change: 0.53, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.2 },
  { name: "Healthcare", color: "#34d399", return30d: 0.2 },
  { name: "Financials", color: "#fbbf24", return30d: 7.7 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.0 },
  { name: "Communication", color: "#a78bfa", return30d: 7.0 },
  { name: "Industrials", color: "#fb923c", return30d: 8.8 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 34.6 },
  { name: "Software", color: "#e879f9", return30d: 9.4 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 8.7 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 1.6 },
