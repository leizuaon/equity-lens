/*  Auto-generated by fetch_data.py — May 12, 2026 16:19
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7351.82, change: -0.82, ytd: 7.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28769.86, change: -1.88, ytd: 14.1 },
  { ticker: "DJI", name: "Dow Jones", value: 49538.64, change: -0.33, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2805.64, change: -2.26, ytd: 11.9 },
  { ticker: "VIX", name: "Volatility", value: 18.85, change: 2.56, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.45, change: 0.93, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 18.5 },
  { name: "Healthcare", color: "#34d399", return30d: -1.5 },
  { name: "Financials", color: "#fbbf24", return30d: -0.5 },
  ...
  { name: "Software", color: "#e879f9", return30d: 13.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.9 },
