/*  Auto-generated by fetch_data.py — April 23, 2026 17:22
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7088.31, change: -0.69, ytd: 3.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26734.51, change: -0.75, ytd: 6.1 },
  { ticker: "DJI", name: "Dow Jones", value: 49108.95, change: -0.77, ytd: 1.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2776.39, change: -0.32, ytd: 10.7 },
  { ticker: "VIX", name: "Volatility", value: 19.46, change: 2.85, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.31, change: 0.3, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 13.5 },
  { name: "Healthcare", color: "#34d399", return30d: 0.5 },
  { name: "Financials", color: "#fbbf24", return30d: 4.6 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 6.7 },
  { name: "Communication", color: "#a78bfa", return30d: 3.8 },
  { name: "Industrials", color: "#fb923c", return30d: 6.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.5 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 22.8 },
  { name: "Software", color: "#e879f9", return30d: -1.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: -0.9 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 6.7 },
];
