/*  Auto-generated by fetch_data.py — May 22, 2026 16:27
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7489.27, change: 0.58, ytd: 9.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29579.17, change: 0.76, ytd: 17.3 },
  { ticker: "DJI", name: "Dow Jones", value: 50693.94, change: 0.81, ytd: 4.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2868.04, change: 0.86, ytd: 14.3 },
  { ticker: "VIX", name: "Volatility", value: 16.58, change: -1.07, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.57, change: -0.31, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.5 },
  { name: "Healthcare", color: "#34d399", return30d: 2.3 },
  { name: "Financials", color: "#fbbf24", return30d: -0.4 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 0.3 },
  { name: "Communication", color: "#a78bfa", return30d: -1.9 },
  ...
  { name: "Software", color: "#e879f9", return30d: 5.9 },
