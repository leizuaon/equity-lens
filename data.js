/*  Auto-generated by fetch_data.py — April 22, 2026 15:15
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7122.68, change: 0.83, ytd: 3.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26817.43, change: 1.28, ytd: 6.4 },
  { ticker: "DJI", name: "Dow Jones", value: 49512.87, change: 0.74, ytd: 2.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2784.8, change: 0.72, ytd: 11.0 },
  { ticker: "VIX", name: "Volatility", value: 19.13, change: -1.9, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.29, change: -0.09, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.5 },
  { name: "Healthcare", color: "#34d399", return30d: 1.4 },
  { name: "Financials", color: "#fbbf24", return30d: 6.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.3 },
  { name: "Communication", color: "#a78bfa", return30d: 4.4 },
  { name: "Industrials", color: "#fb923c", return30d: 5.0 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 20.5 },
  { name: "Software", color: "#e879f9", return30d: 4.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 2.9 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.2 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 11.0 },
];
