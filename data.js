/*  Auto-generated by fetch_data.py — April 29, 2026 15:57
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7120.31, change: -0.26, ytd: 3.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27091.48, change: 0.23, ytd: 7.5 },
  { ticker: "DJI", name: "Dow Jones", value: 48770.72, change: -0.76, ytd: 0.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2738.98, change: -0.62, ytd: 9.2 },
  { ticker: "VIX", name: "Volatility", value: 18.27, change: 2.47, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.4, change: 1.06, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 24.2 },
  { name: "Healthcare", color: "#34d399", return30d: -0.7 },
  { name: "Financials", color: "#fbbf24", return30d: 7.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.2 },
  { name: "Communication", color: "#a78bfa", return30d: 6.7 },
  { name: "Industrials", color: "#fb923c", return30d: 8.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.1 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 36.8 },
  { name: "Software", color: "#e879f9", return30d: 7.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 10.1 },
