/*  Auto-generated by fetch_data.py — May 22, 2026 19:47
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7469.17, change: 0.31, ytd: 8.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29466.58, change: 0.37, ytd: 16.9 },
  { ticker: "DJI", name: "Dow Jones", value: 50585.9, change: 0.6, ytd: 4.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2864.71, change: 0.75, ytd: 14.2 },
  { ticker: "VIX", name: "Volatility", value: 16.83, change: 0.42, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.56, change: -0.61, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.0 },
  { name: "Healthcare", color: "#34d399", return30d: 2.4 },
  { name: "Financials", color: "#fbbf24", return30d: -0.6 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 20.8 },
  { name: "Software", color: "#e879f9", return30d: 5.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 16.9 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 2.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -7.0 },
];
