/*  Auto-generated by fetch_data.py — June 09, 2026 16:32
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7287.46, change: -1.6, ytd: 6.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28475.21, change: -3.19, ytd: 13.0 },
  { ticker: "DJI", name: "Dow Jones", value: 50512.5, change: -0.54, ytd: 4.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2812.91, change: -1.49, ytd: 12.1 },
  { ticker: "VIX", name: "Volatility", value: 21.68, change: 14.59, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.52, change: -0.62, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: -1.6 },
  { name: "Healthcare", color: "#34d399", return30d: 7.8 },
  { name: "Financials", color: "#fbbf24", return30d: 2.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -3.5 },
  { name: "Communication", color: "#a78bfa", return30d: -3.9 },
  { name: "Industrials", color: "#fb923c", return30d: -1.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: -2.3 },
  { name: "Software", color: "#e879f9", return30d: 0.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 8.7 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.0 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -7.6 },
];
