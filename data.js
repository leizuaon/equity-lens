/*  Auto-generated by fetch_data.py — May 05, 2026 15:54
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7256.18, change: 0.77, ytd: 5.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28018.18, change: 1.32, ytd: 11.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49196.1, change: 0.52, ytd: 1.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2837.76, change: 1.49, ytd: 13.1 },
  { ticker: "VIX", name: "Volatility", value: 17.54, change: -4.1, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.41, change: -0.76, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.8 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 32.5 },
  { name: "Software", color: "#e879f9", return30d: 9.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 7.9 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -4.6 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 9.0 },
];
