/*  Auto-generated by fetch_data.py — May 01, 2026 19:14
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7243.16, change: 0.47, ytd: 5.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27744.77, change: 1.07, ytd: 10.1 },
  { ticker: "DJI", name: "Dow Jones", value: 49576.41, change: -0.15, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2809.35, change: 0.34, ytd: 12.0 },
  { ticker: "VIX", name: "Volatility", value: 16.9, change: 0.06, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.38, change: -0.27, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 20.1 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: 5.0 },
  { name: "Industrials", color: "#fb923c", return30d: 5.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.2 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 30.2 },
  { name: "Software", color: "#e879f9", return30d: 8.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 6.4 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.0 },
];
