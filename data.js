/*  Auto-generated by fetch_data.py — June 05, 2026 16:30
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7461.14, change: -1.62, ytd: 8.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29496.22, change: -3.0, ytd: 17.0 },
  { ticker: "DJI", name: "Dow Jones", value: 51160.27, change: -0.78, ytd: 5.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2865.0, change: -2.4, ytd: 14.2 },
  { ticker: "VIX", name: "Volatility", value: 17.86, change: 15.97, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.54, change: 1.41, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 11.1 },
  { name: "Healthcare", color: "#34d399", return30d: 6.4 },
  { name: "Financials", color: "#fbbf24", return30d: 1.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -1.6 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 12.3 },
  { name: "Software", color: "#e879f9", return30d: 9.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 17.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 7.1 },
