/*  Auto-generated by fetch_data.py — June 12, 2026 16:45
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7417.9, change: 0.32, ytd: 8.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29574.48, change: 0.44, ytd: 17.3 },
  { ticker: "DJI", name: "Dow Jones", value: 51143.59, change: 0.58, ytd: 5.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2950.86, change: 1.02, ytd: 17.6 },
  { ticker: "VIX", name: "Volatility", value: 18.93, change: -2.62, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.48, change: 0.4, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 5.4 },
  { name: "Healthcare", color: "#34d399", return30d: 5.5 },
  { name: "Financials", color: "#fbbf24", return30d: 3.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -2.3 },
  { name: "Communication", color: "#a78bfa", return30d: -3.5 },
  { name: "Industrials", color: "#fb923c", return30d: 0.9 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 10.5 },
  { name: "Software", color: "#e879f9", return30d: 1.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.8 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 4.0 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -4.9 },
];
