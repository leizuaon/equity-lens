/*  Auto-generated by fetch_data.py — April 29, 2026 22:58
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7135.95, change: -0.04, ytd: 4.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27186.98, change: 0.58, ytd: 7.9 },
  { ticker: "DJI", name: "Dow Jones", value: 48861.81, change: -0.57, ytd: 1.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2739.47, change: -0.6, ytd: 9.2 },
  { ticker: "VIX", name: "Volatility", value: 18.81, change: 5.5, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.42, change: 1.47, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 24.8 },
  { name: "Healthcare", color: "#34d399", return30d: -0.7 },
  { name: "Financials", color: "#fbbf24", return30d: 7.4 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.6 },
  { name: "Communication", color: "#a78bfa", return30d: 6.8 },
  { name: "Industrials", color: "#fb923c", return30d: 8.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 37.8 },
  { name: "Software", color: "#e879f9", return30d: 8.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 11.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 1.1 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.3 },
];
