/*  Auto-generated by fetch_data.py — April 23, 2026 19:11
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7101.48, change: -0.51, ytd: 3.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26737.6, change: -0.74, ytd: 6.1 },
  { ticker: "DJI", name: "Dow Jones", value: 49291.29, change: -0.4, ytd: 1.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2770.97, change: -0.52, ytd: 10.5 },
  { ticker: "VIX", name: "Volatility", value: 19.59, change: 3.54, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.32, change: 0.63, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 13.5 },
  { name: "Healthcare", color: "#34d399", return30d: 1.0 },
  { name: "Financials", color: "#fbbf24", return30d: 5.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 6.9 },
  { name: "Communication", color: "#a78bfa", return30d: 4.3 },
  { name: "Industrials", color: "#fb923c", return30d: 6.6 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 22.2 },
  { name: "Software", color: "#e879f9", return30d: -1.1 },
  { name: "Cybersecurity", color: "#f472b6", return30d: -0.2 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.3 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 7.2 },
];
