/*  Auto-generated by fetch_data.py — April 27, 2026 19:25
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7175.36, change: 0.14, ytd: 4.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27286.5, change: -0.06, ytd: 8.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49218.49, change: -0.02, ytd: 1.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2787.79, change: 0.03, ytd: 11.1 },
...
const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.3 },
  { name: "Healthcare", color: "#34d399", return30d: 0.3 },
  { name: "Financials", color: "#fbbf24", return30d: 8.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.7 },
  { name: "Communication", color: "#a78bfa", return30d: 8.4 },
  { name: "Industrials", color: "#fb923c", return30d: 8.4 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 0.8 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 34.7 },
  { name: "Software", color: "#e879f9", return30d: 11.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -0.1 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 13.7 },
];
