/*  Auto-generated by fetch_data.py — April 20, 2026 20:50
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7109.14, change: -0.24, ytd: 3.7 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26590.34, change: -0.31, ytd: 5.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49442.56, change: -0.01, ytd: 2.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2792.96, change: 0.58, ytd: 11.4 },
  { ticker: "VIX", name: "Volatility", value: 18.87, change: 7.95, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.25, change: 0.09, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 12.9 },
  { name: "Healthcare", color: "#34d399", return30d: 1.8 },
  { name: "Financials", color: "#fbbf24", return30d: 6.8 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.9 },
  { name: "Communication", color: "#a78bfa", return30d: 5.4 },
  { name: "Industrials", color: "#fb923c", return30d: 6.7 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.5 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 18.6 },
  { name: "Software", color: "#e879f9", return30d: 2.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 1.2 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 3.8 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.4 },
];
