/*  Auto-generated by fetch_data.py — April 24, 2026 18:55
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7157.13, change: 0.69, ytd: 4.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27264.8, change: 1.8, ytd: 8.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49179.3, change: -0.27, ytd: 1.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2790.55, change: 0.56, ytd: 11.3 },
  { ticker: "VIX", name: "Volatility", value: 18.55, change: -3.94, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.31, change: -0.21, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.2 },
  { name: "Communication", color: "#a78bfa", return30d: 4.1 },
  { name: "Industrials", color: "#fb923c", return30d: 5.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 28.3 },
  { name: "Software", color: "#e879f9", return30d: 5.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 4.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 9.3 },
];
