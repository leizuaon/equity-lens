/*  Auto-generated by fetch_data.py — April 14, 2026 22:47
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 6967.38, change: 1.18, ytd: 1.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 25842.0, change: 1.81, ytd: 2.5 },
  { ticker: "DJI", name: "Dow Jones", value: 48535.99, change: 0.66, ytd: 0.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2705.67, change: 1.32, ytd: 7.9 },
...
const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 6.7 },
  ...
  { name: "Software", color: "#e879f9", return30d: -6.4 },
];
