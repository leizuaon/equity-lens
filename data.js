/*  Auto-generated by fetch_data.py — May 15, 2026 16:04
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7421.59, change: -1.06, ytd: 8.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29182.21, change: -1.35, ytd: 15.8 },
  { ticker: "DJI", name: "Dow Jones", value: 49549.52, change: -1.03, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2798.24, change: -2.27, ytd: 11.6 },
  { ticker: "VIX", name: "Volatility", value: 18.41, change: 6.66, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.59, change: 2.82, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 17.7 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: -0.9 },
  { name: "Industrials", color: "#fb923c", return30d: 0.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 4.5 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 23.6 },
  { name: "Software", color: "#e879f9", return30d: 10.0 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.8 },
