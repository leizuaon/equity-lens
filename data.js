/*  Auto-generated by fetch_data.py — April 27, 2026 22:54
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7173.91, change: 0.12, ytd: 4.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27305.68, change: 0.01, ytd: 8.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49167.79, change: -0.13, ytd: 1.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2788.19, change: 0.04, ytd: 11.2 },
  { ticker: "VIX", name: "Volatility", value: 18.02, change: -3.69, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.34, change: 0.6, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 25.9 },
  { name: "Healthcare", color: "#34d399", return30d: -0.3 },
  { name: "Financials", color: "#fbbf24", return30d: 7.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.5 },
  { name: "Communication", color: "#a78bfa", return30d: 7.3 },
  { name: "Industrials", color: "#fb923c", return30d: 10.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 0.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 39.6 },
  { name: "Software", color: "#e879f9", return30d: 10.1 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.8 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 2.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.6 },
];
