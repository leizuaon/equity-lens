/*  Auto-generated by fetch_data.py — May 30, 2026 15:13
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7580.06, change: 0.22, ytd: 10.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30333.18, change: 0.36, ytd: 20.3 },
  { ticker: "DJI", name: "Dow Jones", value: 51032.46, change: 0.72, ytd: 5.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2919.34, change: -0.59, ytd: 16.4 },
  { ticker: "VIX", name: "Volatility", value: 15.32, change: -2.67, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.45, change: -0.04, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.8 },
  { name: "Healthcare", color: "#34d399", return30d: 2.4 },
  { name: "Financials", color: "#fbbf24", return30d: -1.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 2.1 },
  { name: "Communication", color: "#a78bfa", return30d: -0.7 },
  { name: "Industrials", color: "#fb923c", return30d: -0.8 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -1.7 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 18.2 },
  { name: "Software", color: "#e879f9", return30d: 21.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 25.4 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 7.7 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -1.6 },
];
