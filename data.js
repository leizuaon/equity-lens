/*  Auto-generated by fetch_data.py — May 07, 2026 16:06
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7354.42, change: -0.15, ytd: 7.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28619.36, change: 0.07, ytd: 13.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49775.69, change: -0.27, ytd: 2.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2864.76, change: -0.76, ytd: 14.2 },
  { ticker: "VIX", name: "Volatility", value: 17.28, change: -0.63, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.37, change: 0.23, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.4 },
  { name: "Communication", color: "#a78bfa", return30d: 5.4 },
  { name: "Industrials", color: "#fb923c", return30d: 6.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 35.6 },
  { name: "Software", color: "#e879f9", return30d: 13.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 7.6 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.1 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 10.6 },
];
