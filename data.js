/*  Auto-generated by fetch_data.py — April 15, 2026 19:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7019.8, change: 0.75, ytd: 2.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26146.28, change: 1.18, ytd: 3.7 },
  { ticker: "DJI", name: "Dow Jones", value: 48468.98, change: -0.14, ytd: 0.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2709.3, change: 0.13, ytd: 8.0 },
  { ticker: "VIX", name: "Volatility", value: 17.88, change: -2.61, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.28, change: 0.61, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 8.1 },
  { name: "Healthcare", color: "#34d399", return30d: -1.7 },
  { name: "Financials", color: "#fbbf24", return30d: 6.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 5.6 },
  { name: "Communication", color: "#a78bfa", return30d: 2.3 },
  { name: "Industrials", color: "#fb923c", return30d: 3.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -4.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 14.3 },
