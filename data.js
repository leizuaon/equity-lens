/*  Auto-generated by fetch_data.py — April 27, 2026 15:50
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7154.56, change: -0.15, ytd: 4.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27227.81, change: -0.28, ytd: 8.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49086.16, change: -0.29, ytd: 1.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2784.24, change: -0.1, ytd: 11.0 },
  { ticker: "VIX", name: "Volatility", value: 18.74, change: 0.16, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.34, change: 0.6, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 22.8 },
  { name: "Healthcare", color: "#34d399", return30d: 0.6 },
  { name: "Financials", color: "#fbbf24", return30d: 8.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.2 },
  { name: "Communication", color: "#a78bfa", return30d: 8.6 },
  { name: "Industrials", color: "#fb923c", return30d: 8.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.2 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 34.2 },
  { name: "Software", color: "#e879f9", return30d: 11.1 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -0.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 13.8 },
];
