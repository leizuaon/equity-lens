/*  Auto-generated by fetch_data.py — April 29, 2026 19:28
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7135.0, change: -0.05, ytd: 4.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27185.41, change: 0.58, ytd: 7.9 },
  { ticker: "DJI", name: "Dow Jones", value: 48853.95, change: -0.59, ytd: 1.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2735.04, change: -0.76, ytd: 9.0 },
  { ticker: "VIX", name: "Volatility", value: 18.33, change: 2.8, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.42, change: 1.47, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 24.7 },
  { name: "Healthcare", color: "#34d399", return30d: -0.7 },
  { name: "Financials", color: "#fbbf24", return30d: 7.4 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.5 },
  { name: "Communication", color: "#a78bfa", return30d: 7.0 },
  { name: "Industrials", color: "#fb923c", return30d: 8.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 37.7 },
  { name: "Software", color: "#e879f9", return30d: 8.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 11.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.8 },
