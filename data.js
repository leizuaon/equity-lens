/*  Auto-generated by fetch_data.py — May 29, 2026 17:34
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7581.49, change: 0.24, ytd: 10.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30296.09, change: 0.24, ytd: 20.2 },
  { ticker: "DJI", name: "Dow Jones", value: 51020.88, change: 0.69, ytd: 5.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2922.43, change: -0.48, ytd: 16.5 },
  { ticker: "VIX", name: "Volatility", value: 15.27, change: -2.99, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.44, change: -0.43, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.5 },
  { name: "Healthcare", color: "#34d399", return30d: 4.6 },
  { name: "Financials", color: "#fbbf24", return30d: -0.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 3.9 },
  { name: "Communication", color: "#a78bfa", return30d: 0.4 },
  { name: "Industrials", color: "#fb923c", return30d: 2.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 0.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 20.0 },
  { name: "Software", color: "#e879f9", return30d: 19.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 22.4 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 10.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -0.7 },
];
