/*  Auto-generated by fetch_data.py — May 06, 2026 22:54
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7365.12, change: 1.46, ytd: 7.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28599.17, change: 2.08, ytd: 13.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49910.59, change: 1.24, ytd: 3.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2886.77, change: 1.47, ytd: 15.1 },
  { ticker: "VIX", name: "Volatility", value: 17.39, change: 0.06, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.36, change: -1.36, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.7 },
  { name: "Healthcare", color: "#34d399", return30d: -0.8 },
  { name: "Financials", color: "#fbbf24", return30d: 3.9 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.2 },
  { name: "Communication", color: "#a78bfa", return30d: 4.9 },
  { name: "Industrials", color: "#fb923c", return30d: 7.7 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.7 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 37.5 },
  ...
  { name: "Digital Payments", color: "#fcd34d", return30d: 9.6 },
];
