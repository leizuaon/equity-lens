/*  Auto-generated by fetch_data.py — May 19, 2026 16:50
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7372.92, change: -0.41, ytd: 7.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28879.94, change: -0.39, ytd: 14.6 },
  { ticker: "DJI", name: "Dow Jones", value: 49552.15, change: -0.27, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2750.28, change: -0.89, ytd: 9.7 },
  { ticker: "VIX", name: "Volatility", value: 17.84, change: 0.11, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.66, change: 0.87, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 12.4 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: -2.4 },
  { name: "Industrials", color: "#fb923c", return30d: -2.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 4.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 17.9 },
  { name: "Software", color: "#e879f9", return30d: 6.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -5.7 },
