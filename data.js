/*  Auto-generated by fetch_data.py — May 21, 2026 16:40
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7402.69, change: -0.41, ytd: 7.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29154.79, change: -0.49, ytd: 15.7 },
  { ticker: "DJI", name: "Dow Jones", value: 49869.29, change: -0.28, ytd: 3.1 },
  { ticker: "RUT", name: "Russell 2000", value: 2819.19, change: 0.06, ytd: 12.4 },
  { ticker: "VIX", name: "Volatility", value: 17.29, change: -0.86, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.61, change: 0.72, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.4 },
  ...
  { name: "Industrials", color: "#fb923c", return30d: -1.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 21.0 },
  { name: "Software", color: "#e879f9", return30d: 6.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.2 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -0.9 },
