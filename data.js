/*  Auto-generated by fetch_data.py — May 26, 2026 17:27
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7504.84, change: 0.42, ytd: 9.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29888.76, change: 1.38, ytd: 18.6 },
  { ticker: "DJI", name: "Dow Jones", value: 50392.17, change: -0.37, ytd: 4.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2913.83, change: 1.55, ytd: 16.2 },
  { ticker: "VIX", name: "Volatility", value: 17.12, change: 3.19, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.5, change: -1.18, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.9 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 18.0 },
  { name: "Software", color: "#e879f9", return30d: 10.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 20.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 6.3 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -3.4 },
];
