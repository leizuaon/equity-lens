/*  Auto-generated by fetch_data.py — May 13, 2026 16:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7428.27, change: 0.37, ytd: 8.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29276.64, change: 0.73, ytd: 16.1 },
  { ticker: "DJI", name: "Dow Jones", value: 49580.23, change: -0.36, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2833.91, change: -0.31, ytd: 13.0 },
  { ticker: "VIX", name: "Volatility", value: 18.05, change: 0.33, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.49, change: 0.6, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 21.2 },
  { name: "Healthcare", color: "#34d399", return30d: -1.1 },
  { name: "Financials", color: "#fbbf24", return30d: -1.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 4.3 },
  { name: "Communication", color: "#a78bfa", return30d: 1.3 },
  { name: "Industrials", color: "#fb923c", return30d: 0.6 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 28.9 },
  { name: "Software", color: "#e879f9", return30d: 11.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.0 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -0.8 },
];
