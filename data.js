/*  Auto-generated by fetch_data.py — May 13, 2026 19:57
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7444.22, change: 0.58, ytd: 8.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29356.19, change: 1.0, ytd: 16.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49682.37, change: -0.16, ytd: 2.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2850.24, change: 0.26, ytd: 13.6 },
  { ticker: "VIX", name: "Volatility", value: 17.76, change: -1.28, ytd: null },
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Communication", color: "#a78bfa", return30d: 1.7 },
  { name: "Industrials", color: "#fb923c", return30d: 0.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 29.0 },
  { name: "Software", color: "#e879f9", return30d: 12.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 14.8 },
