/*  Auto-generated by fetch_data.py — May 28, 2026 23:18
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7563.63, change: 0.58, ytd: 10.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30223.89, change: 0.84, ytd: 19.9 },
  { ticker: "DJI", name: "Dow Jones", value: 50668.97, change: 0.05, ytd: 4.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2936.57, change: 0.57, ytd: 17.1 },
  { ticker: "VIX", name: "Volatility", value: 15.74, change: -3.38, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.45, change: -0.58, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 17.4 },
  { name: "Healthcare", color: "#34d399", return30d: 5.6 },
  { name: "Financials", color: "#fbbf24", return30d: -1.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 4.5 },
  { name: "Communication", color: "#a78bfa", return30d: 1.2 },
  { name: "Industrials", color: "#fb923c", return30d: 2.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.8 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 20.1 },
  { name: "Software", color: "#e879f9", return30d: 13.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 16.6 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 10.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -2.8 },
];
