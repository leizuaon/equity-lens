/*  Auto-generated by fetch_data.py — May 08, 2026 21:02
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7398.93, change: 0.84, ytd: 7.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29234.99, change: 2.35, ytd: 16.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49609.16, change: 0.02, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2861.21, change: 0.76, ytd: 14.1 },
  { ticker: "VIX", name: "Volatility", value: 17.19, change: 0.64, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.36, change: -0.64, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.5 },
  { name: "Healthcare", color: "#34d399", return30d: -3.9 },
  { name: "Financials", color: "#fbbf24", return30d: -0.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 6.6 },
  { name: "Communication", color: "#a78bfa", return30d: 2.3 },
  { name: "Industrials", color: "#fb923c", return30d: 0.6 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 0.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 31.7 },
  { name: "Software", color: "#e879f9", return30d: 18.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 14.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.6 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 6.3 },
];
