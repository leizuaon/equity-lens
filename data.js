/*  Auto-generated by fetch_data.py — June 12, 2026 23:18
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7431.46, change: 0.5, ytd: 8.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29635.95, change: 0.64, ytd: 17.6 },
  { ticker: "DJI", name: "Dow Jones", value: 51202.26, change: 0.7, ytd: 5.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2943.99, change: 0.79, ytd: 17.4 },
  { ticker: "VIX", name: "Volatility", value: 17.68, change: -9.05, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.49, change: 0.54, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 4.5 },
  { name: "Healthcare", color: "#34d399", return30d: 4.8 },
  { name: "Financials", color: "#fbbf24", return30d: 4.6 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -1.8 },
  ...
  { name: "Software", color: "#e879f9", return30d: 2.4 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 12.8 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 3.6 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -2.0 },
];
