/*  Auto-generated by fetch_data.py — April 30, 2026 15:51
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7168.06, change: 0.45, ytd: 4.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27260.96, change: 0.27, ytd: 8.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49528.9, change: 1.37, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2777.17, change: 1.38, ytd: 10.7 },
  { ticker: "VIX", name: "Volatility", value: 17.38, change: -7.6, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.39, change: -0.59, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 24.3 },
  { name: "Healthcare", color: "#34d399", return30d: 1.4 },
  { name: "Financials", color: "#fbbf24", return30d: 7.7 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.0 },
  { name: "Communication", color: "#a78bfa", return30d: 7.1 },
  { name: "Industrials", color: "#fb923c", return30d: 11.0 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 38.7 },
  { name: "Software", color: "#e879f9", return30d: 7.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.2 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 3.1 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.7 },
];
