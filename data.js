/*  Auto-generated by fetch_data.py — April 22, 2026 22:50
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7137.9, change: 1.05, ytd: 4.1 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26937.28, change: 1.73, ytd: 6.9 },
  { ticker: "DJI", name: "Dow Jones", value: 49490.03, change: 0.69, ytd: 2.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2785.38, change: 0.74, ytd: 11.0 },
  { ticker: "VIX", name: "Volatility", value: 18.92, change: -2.97, ytd: null },
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Communication", color: "#a78bfa", return30d: 4.6 },
  { name: "Industrials", color: "#fb923c", return30d: 4.9 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.1 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 21.8 },
  { name: "Software", color: "#e879f9", return30d: 5.1 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 3.7 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -1.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 11.5 },
];
