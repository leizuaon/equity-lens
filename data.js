/*  Auto-generated by fetch_data.py — May 11, 2026 19:49
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7407.46, change: 0.12, ytd: 8.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29285.82, change: 0.17, ytd: 16.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49653.69, change: 0.09, ytd: 2.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2873.05, change: 0.41, ytd: 14.5 },
  { ticker: "VIX", name: "Volatility", value: 18.41, change: 7.1, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.41, change: 1.05, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 22.0 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: 0.6 },
  { name: "Industrials", color: "#fb923c", return30d: 1.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.1 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 29.8 },
  { name: "Software", color: "#e879f9", return30d: 15.0 },
