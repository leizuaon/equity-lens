/*  Auto-generated by fetch_data.py — May 07, 2026 19:44
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7334.23, change: -0.42, ytd: 6.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28553.13, change: -0.16, ytd: 13.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49574.22, change: -0.67, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2834.28, change: -1.82, ytd: 13.0 },
  { ticker: "VIX", name: "Volatility", value: 17.34, change: -0.29, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.39, change: 0.83, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.4 },
  { name: "Healthcare", color: "#34d399", return30d: -1.5 },
  { name: "Financials", color: "#fbbf24", return30d: 3.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.1 },
  { name: "Communication", color: "#a78bfa", return30d: 4.8 },
  { name: "Industrials", color: "#fb923c", return30d: 5.9 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 35.2 },
  { name: "Software", color: "#e879f9", return30d: 12.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 7.4 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -0.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 10.0 },
];
