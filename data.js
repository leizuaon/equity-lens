/*  Auto-generated by fetch_data.py — May 27, 2026 17:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7510.01, change: -0.12, ytd: 9.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29869.88, change: -0.44, ytd: 18.5 },
  { ticker: "DJI", name: "Dow Jones", value: 50670.42, change: 0.41, ytd: 4.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2924.79, change: 0.15, ytd: 16.6 },
  { ticker: "VIX", name: "Volatility", value: 16.75, change: -1.53, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.48, change: -0.22, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.2 },
  { name: "Healthcare", color: "#34d399", return30d: 3.7 },
  { name: "Financials", color: "#fbbf24", return30d: -0.7 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 3.1 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 16.6 },
