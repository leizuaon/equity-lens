/*  Auto-generated by fetch_data.py — May 17, 2026 15:01
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7408.5, change: -1.24, ytd: 8.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29125.2, change: -1.54, ytd: 15.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49526.17, change: -1.07, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2793.3, change: -2.44, ytd: 11.4 },
  { ticker: "VIX", name: "Volatility", value: 18.43, change: 6.78, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.59, change: 3.0, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 15.9 },
  { name: "Healthcare", color: "#34d399", return30d: -1.0 },
  { name: "Financials", color: "#fbbf24", return30d: -1.8 },
  ...
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 22.3 },
  { name: "Software", color: "#e879f9", return30d: 8.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.9 },
