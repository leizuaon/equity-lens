/*  Auto-generated by fetch_data.py — April 30, 2026 19:24
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7214.73, change: 1.1, ytd: 5.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27463.71, change: 1.02, ytd: 9.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49716.61, change: 1.75, ytd: 2.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2795.13, change: 2.03, ytd: 11.4 },
  { ticker: "VIX", name: "Volatility", value: 17.13, change: -8.93, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.39, change: -0.63, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 25.2 },
  { name: "Healthcare", color: "#34d399", return30d: 1.5 },
  { name: "Financials", color: "#fbbf24", return30d: 7.9 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 12.3 },
  { name: "Communication", color: "#a78bfa", return30d: 7.9 },
  { name: "Industrials", color: "#fb923c", return30d: 11.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 39.5 },
  { name: "Software", color: "#e879f9", return30d: 8.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 3.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.8 },
];
