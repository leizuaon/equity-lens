/*  Auto-generated by fetch_data.py — May 26, 2026 20:10
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7519.12, change: 0.61, ytd: 9.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30001.32, change: 1.76, ytd: 19.0 },
  { ticker: "DJI", name: "Dow Jones", value: 50461.68, change: -0.23, ytd: 4.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2921.07, change: 1.81, ytd: 16.5 },
  { ticker: "VIX", name: "Volatility", value: 16.92, change: 1.99, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.49, change: -1.43, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 15.3 },
  { name: "Healthcare", color: "#34d399", return30d: 3.5 },
  { name: "Financials", color: "#fbbf24", return30d: 0.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 1.4 },
  { name: "Communication", color: "#a78bfa", return30d: -0.3 },
  { name: "Industrials", color: "#fb923c", return30d: 1.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 18.9 },
  { name: "Software", color: "#e879f9", return30d: 10.1 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 20.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 6.3 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -3.6 },
];
