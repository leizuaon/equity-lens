/*  Auto-generated by fetch_data.py — April 30, 2026 17:23
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7177.29, change: 0.58, ytd: 4.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27304.01, change: 0.43, ytd: 8.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49542.66, change: 1.39, ytd: 2.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2783.35, change: 1.6, ytd: 11.0 },
  { ticker: "VIX", name: "Volatility", value: 17.36, change: -7.71, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.4, change: -0.5, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Communication", color: "#a78bfa", return30d: 7.4 },
  { name: "Industrials", color: "#fb923c", return30d: 11.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.7 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 39.1 },
  { name: "Software", color: "#e879f9", return30d: 7.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 8.7 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 3.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.2 },
];
