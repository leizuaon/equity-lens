/*  Auto-generated by fetch_data.py — April 16, 2026 15:27
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7041.09, change: 0.26, ytd: 2.7 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26336.27, change: 0.5, ytd: 4.5 },
  { ticker: "DJI", name: "Dow Jones", value: 48501.96, change: 0.08, ytd: 0.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2715.07, change: 0.05, ytd: 8.2 },
  { ticker: "VIX", name: "Volatility", value: 18.62, change: 2.48, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.29, change: 0.12, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 9.4 },
  { name: "Healthcare", color: "#34d399", return30d: -2.2 },
  { name: "Financials", color: "#fbbf24", return30d: 6.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 5.3 },
  { name: "Communication", color: "#a78bfa", return30d: 3.2 },
  { name: "Industrials", color: "#fb923c", return30d: 3.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -3.7 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 15.7 },
  { name: "Software", color: "#e879f9", return30d: -0.7 },
];
