/*  Auto-generated by fetch_data.py — April 24, 2026 16:59
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7159.91, change: 0.72, ytd: 4.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27267.08, change: 1.81, ytd: 8.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49171.43, change: -0.28, ytd: 1.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2790.26, change: 0.55, ytd: 11.2 },
  { ticker: "VIX", name: "Volatility", value: 18.81, change: -2.59, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.31, change: -0.3, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 17.6 },
  { name: "Healthcare", color: "#34d399", return30d: -0.5 },
  { name: "Financials", color: "#fbbf24", return30d: 4.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.1 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 28.7 },
  { name: "Software", color: "#e879f9", return30d: 4.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 3.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.2 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 9.4 },
];
