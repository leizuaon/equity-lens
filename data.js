/*  Auto-generated by fetch_data.py — April 23, 2026 15:54
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7131.54, change: -0.09, ytd: 4.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26916.34, change: -0.08, ytd: 6.8 },
  { ticker: "DJI", name: "Dow Jones", value: 49408.5, change: -0.16, ytd: 2.1 },
  { ticker: "RUT", name: "Russell 2000", value: 2792.05, change: 0.24, ytd: 11.3 },
  { ticker: "VIX", name: "Volatility", value: 19.02, change: 0.53, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.29, change: -0.0, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 7.5 },
  { name: "Communication", color: "#a78bfa", return30d: 4.5 },
  { name: "Industrials", color: "#fb923c", return30d: 6.9 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 24.0 },
  { name: "Software", color: "#e879f9", return30d: -0.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 0.0 },
