/*  Auto-generated by fetch_data.py — May 14, 2026 19:47
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7505.65, change: 0.82, ytd: 9.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29617.9, change: 0.85, ytd: 17.5 },
  { ticker: "DJI", name: "Dow Jones", value: 50069.47, change: 0.76, ytd: 3.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2862.77, change: 0.66, ytd: 14.1 },
  { ticker: "VIX", name: "Volatility", value: 17.27, change: -3.36, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.46, change: -0.45, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 2.0 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 28.4 },
  { name: "Software", color: "#e879f9", return30d: 14.0 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 19.4 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -4.7 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -1.3 },
];
