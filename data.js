/*  Auto-generated by fetch_data.py — June 04, 2026 20:07
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7584.31, change: 0.41, ytd: 10.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30407.81, change: -0.53, ytd: 20.6 },
  { ticker: "DJI", name: "Dow Jones", value: 51561.93, change: 1.73, ytd: 6.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2939.12, change: 1.58, ytd: 17.2 },
  { ticker: "VIX", name: "Volatility", value: 15.24, change: -5.11, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.48, change: -0.31, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 16.6 },
  { name: "Healthcare", color: "#34d399", return30d: 4.6 },
  { name: "Financials", color: "#fbbf24", return30d: 1.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -0.7 },
  { name: "Communication", color: "#a78bfa", return30d: -2.2 },
  ...
  { name: "Software", color: "#e879f9", return30d: 13.4 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 20.7 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 7.6 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -5.2 },
];
