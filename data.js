/*  Auto-generated by fetch_data.py — June 11, 2026 23:23
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7394.3, change: 1.75, ytd: 7.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29446.18, change: 3.29, ytd: 16.8 },
  { ticker: "DJI", name: "Dow Jones", value: 50848.75, change: 1.86, ytd: 5.1 },
  { ticker: "RUT", name: "Russell 2000", value: 2921.03, change: 3.02, ytd: 16.5 },
  { ticker: "VIX", name: "Volatility", value: 19.44, change: -12.51, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.46, change: -1.74, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 4.6 },
  { name: "Healthcare", color: "#34d399", return30d: 5.6 },
  { name: "Financials", color: "#fbbf24", return30d: 2.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -1.7 },
  { name: "Communication", color: "#a78bfa", return30d: -3.2 },
  { name: "Industrials", color: "#fb923c", return30d: 0.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 8.6 },
  { name: "Software", color: "#e879f9", return30d: 1.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 14.6 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 4.7 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -6.0 },
];
