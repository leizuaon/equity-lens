/*  Auto-generated by fetch_data.py — May 06, 2026 19:48
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7361.94, change: 1.42, ytd: 7.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28560.38, change: 1.95, ytd: 13.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49959.82, change: 1.34, ytd: 3.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2882.95, change: 1.33, ytd: 14.9 },
  { ticker: "VIX", name: "Volatility", value: 17.26, change: -0.69, ytd: null },
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Healthcare", color: "#34d399", return30d: -0.4 },
  { name: "Financials", color: "#fbbf24", return30d: 4.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.2 },
  { name: "Communication", color: "#a78bfa", return30d: 5.1 },
  { name: "Industrials", color: "#fb923c", return30d: 7.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 38.4 },
  { name: "Software", color: "#e879f9", return30d: 8.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 7.2 },
