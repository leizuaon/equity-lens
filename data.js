/*  Auto-generated by fetch_data.py — April 16, 2026 17:17
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7024.52, change: 0.02, ytd: 2.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26281.49, change: 0.29, ytd: 4.3 },
  { ticker: "DJI", name: "Dow Jones", value: 48459.45, change: -0.01, ytd: 0.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2711.95, change: -0.06, ytd: 8.1 },
  { ticker: "VIX", name: "Volatility", value: 18.76, change: 3.25, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.3, change: 0.54, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 9.3 },
  { name: "Healthcare", color: "#34d399", return30d: -2.7 },
  { name: "Financials", color: "#fbbf24", return30d: 6.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 5.0 },
  { name: "Communication", color: "#a78bfa", return30d: 3.1 },
  { name: "Industrials", color: "#fb923c", return30d: 2.7 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -3.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 15.1 },
