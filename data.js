/*  Auto-generated by fetch_data.py — June 02, 2026 18:05
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7604.96, change: 0.07, ytd: 10.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30565.75, change: 0.17, ytd: 21.3 },
  { ticker: "DJI", name: "Dow Jones", value: 51242.8, change: 0.32, ytd: 5.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2925.19, change: 0.67, ytd: 16.6 },
  { ticker: "VIX", name: "Volatility", value: 15.97, change: -0.5, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.45, change: -0.45, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 21.5 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: -1.8 },
  { name: "Industrials", color: "#fb923c", return30d: 1.6 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -1.9 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 23.4 },
  { name: "Software", color: "#e879f9", return30d: 17.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 27.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 6.7 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -4.8 },
];
