/*  Auto-generated by fetch_data.py — April 21, 2026 19:14
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7094.74, change: -0.2, ytd: 3.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26605.12, change: 0.06, ytd: 5.6 },
  { ticker: "DJI", name: "Dow Jones", value: 49323.03, change: -0.24, ytd: 1.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2774.2, change: -0.67, ytd: 10.6 },
  { ticker: "VIX", name: "Volatility", value: 19.74, change: 4.61, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.3, change: 1.06, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 13.6 },
  { name: "Healthcare", color: "#34d399", return30d: 1.2 },
  { name: "Financials", color: "#fbbf24", return30d: 6.4 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.6 },
  { name: "Communication", color: "#a78bfa", return30d: 4.3 },
  { name: "Industrials", color: "#fb923c", return30d: 5.6 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.1 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 19.3 },
  { name: "Software", color: "#e879f9", return30d: 3.3 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 3.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.6 },
