/*  Auto-generated by fetch_data.py — June 03, 2026 18:23
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7571.71, change: -0.5, ytd: 10.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30598.55, change: -0.2, ytd: 21.4 },
  { ticker: "DJI", name: "Dow Jones", value: 50887.02, change: -0.82, ytd: 5.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2897.38, change: -1.18, ytd: 15.5 },
  { ticker: "VIX", name: "Volatility", value: 16.09, change: 2.03, ytd: null },
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Healthcare", color: "#34d399", return30d: 2.2 },
  { name: "Financials", color: "#fbbf24", return30d: -1.1 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -1.0 },
  { name: "Communication", color: "#a78bfa", return30d: -3.3 },
  { name: "Industrials", color: "#fb923c", return30d: 2.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -1.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 26.2 },
  { name: "Software", color: "#e879f9", return30d: 13.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 25.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 5.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -8.9 },
];
