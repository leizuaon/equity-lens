/*  Auto-generated by fetch_data.py — May 19, 2026 21:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7353.61, change: -0.67, ytd: 7.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28818.84, change: -0.61, ytd: 14.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49363.88, change: -0.65, ytd: 2.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2747.07, change: -1.01, ytd: 9.5 },
  { ticker: "VIX", name: "Volatility", value: 18.06, change: 1.35, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.67, change: 0.95, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 12.1 },
  { name: "Healthcare", color: "#34d399", return30d: -0.1 },
  { name: "Financials", color: "#fbbf24", return30d: -2.9 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -4.0 },
  { name: "Communication", color: "#a78bfa", return30d: -2.4 },
  { name: "Industrials", color: "#fb923c", return30d: -3.0 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 4.5 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 17.2 },
  { name: "Software", color: "#e879f9", return30d: 6.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.6 },
