/*  Auto-generated by fetch_data.py — April 27, 2026 17:24
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7166.93, change: 0.03, ytd: 4.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27261.85, change: -0.15, ytd: 8.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49157.98, change: -0.15, ytd: 1.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2786.27, change: -0.03, ytd: 11.1 },
  { ticker: "VIX", name: "Volatility", value: 18.52, change: -1.02, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.34, change: 0.67, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 22.9 },
  { name: "Healthcare", color: "#34d399", return30d: 0.5 },
  { name: "Financials", color: "#fbbf24", return30d: 8.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 11.8 },
  { name: "Communication", color: "#a78bfa", return30d: 8.5 },
  { name: "Industrials", color: "#fb923c", return30d: 8.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 33.9 },
  { name: "Software", color: "#e879f9", return30d: 11.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -0.3 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 13.5 },
];
