/*  Auto-generated by fetch_data.py — April 20, 2026 15:17
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7088.95, change: -0.52, ytd: 3.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26458.04, change: -0.8, ytd: 5.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49296.86, change: -0.3, ytd: 1.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2780.72, change: 0.14, ytd: 10.9 },
  { ticker: "VIX", name: "Volatility", value: 19.56, change: 11.9, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.27, change: 0.52, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 13.5 },
  { name: "Healthcare", color: "#34d399", return30d: 2.5 },
  { name: "Financials", color: "#fbbf24", return30d: 7.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.8 },
  { name: "Communication", color: "#a78bfa", return30d: 6.1 },
