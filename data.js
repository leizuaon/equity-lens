/*  Auto-generated by fetch_data.py — April 28, 2026 21:08
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7138.8, change: -0.49, ytd: 4.1 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27029.01, change: -1.01, ytd: 7.2 },
  { ticker: "DJI", name: "Dow Jones", value: 49141.93, change: -0.05, ytd: 1.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2756.05, change: -1.15, ytd: 9.9 },
  { ticker: "VIX", name: "Volatility", value: 17.83, change: -1.05, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.35, change: 0.42, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 23.8 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: 7.2 },
  { name: "Industrials", color: "#fb923c", return30d: 9.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.5 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 35.5 },
  { name: "Software", color: "#e879f9", return30d: 9.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 9.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 2.6 },
