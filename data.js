/*  Auto-generated by fetch_data.py — May 18, 2026 16:48
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7372.73, change: -0.48, ytd: 7.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28828.68, change: -1.02, ytd: 14.4 },
  { ticker: "DJI", name: "Dow Jones", value: 49497.54, change: -0.06, ytd: 2.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2770.07, change: -0.83, ytd: 10.4 },
  { ticker: "VIX", name: "Volatility", value: 18.62, change: 1.03, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.6, change: 0.09, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 11.9 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 16.8 },
  { name: "Software", color: "#e879f9", return30d: 6.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 14.3 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -5.8 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -8.1 },
];
