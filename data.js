/*  Auto-generated by fetch_data.py — June 08, 2026 17:26
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7420.4, change: 0.5, ytd: 8.2 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29484.78, change: 1.82, ytd: 17.0 },
  { ticker: "DJI", name: "Dow Jones", value: 50810.6, change: -0.11, ytd: 5.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2861.12, change: 0.97, ytd: 14.1 },
  { ticker: "VIX", name: "Volatility", value: 18.7, change: -13.06, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.55, change: 0.4, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 5.3 },
  { name: "Healthcare", color: "#34d399", return30d: 6.3 },
  { name: "Financials", color: "#fbbf24", return30d: 1.6 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -3.8 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 5.7 },
  { name: "Software", color: "#e879f9", return30d: 4.8 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 1.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -7.1 },
];
