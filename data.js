/*  Auto-generated by fetch_data.py — April 25, 2026 14:50
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7165.08, change: 0.8, ytd: 4.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27303.67, change: 1.95, ytd: 8.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49230.71, change: -0.16, ytd: 1.8 },
  { ticker: "RUT", name: "Russell 2000", value: 2787.0, change: 0.43, ytd: 11.1 },
  { ticker: "VIX", name: "Volatility", value: 18.71, change: -3.11, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.31, change: -0.3, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 17.2 },
  { name: "Healthcare", color: "#34d399", return30d: -1.4 },
  { name: "Financials", color: "#fbbf24", return30d: 4.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 7.2 },
  { name: "Communication", color: "#a78bfa", return30d: 3.7 },
  { name: "Industrials", color: "#fb923c", return30d: 4.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.1 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 26.9 },
  { name: "Software", color: "#e879f9", return30d: 6.0 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 3.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -4.5 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 8.7 },
];
