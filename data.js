/*  Auto-generated by fetch_data.py — May 11, 2026 22:55
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7412.84, change: 0.19, ytd: 8.1 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29320.66, change: 0.29, ytd: 16.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49704.47, change: 0.19, ytd: 2.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2870.64, change: 0.33, ytd: 14.4 },
  { ticker: "VIX", name: "Volatility", value: 18.38, change: 6.92, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.41, change: 1.05, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 22.2 },
  { name: "Healthcare", color: "#34d399", return30d: -3.3 },
  { name: "Financials", color: "#fbbf24", return30d: -0.9 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 4.8 },
  ...
  { name: "Software", color: "#e879f9", return30d: 15.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 14.9 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 2.9 },
];
