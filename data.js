/*  Auto-generated by fetch_data.py — May 01, 2026 14:57
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7254.39, change: 0.63, ytd: 5.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27709.2, change: 0.94, ytd: 9.9 },
  { ticker: "DJI", name: "Dow Jones", value: 49785.09, change: 0.27, ytd: 2.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2802.58, change: 0.1, ytd: 11.7 },
  { ticker: "VIX", name: "Volatility", value: 16.75, change: -0.83, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.37, change: -0.5, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.6 },
  { name: "Healthcare", color: "#34d399", return30d: -1.2 },
  { name: "Financials", color: "#fbbf24", return30d: 6.0 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 29.6 },
  { name: "Software", color: "#e879f9", return30d: 7.4 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 5.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.8 },
