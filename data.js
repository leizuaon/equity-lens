/*  Auto-generated by fetch_data.py — June 01, 2026 19:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7612.0, change: 0.42, ytd: 11.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30566.82, change: 0.77, ytd: 21.3 },
  { ticker: "DJI", name: "Dow Jones", value: 51050.82, change: 0.04, ytd: 5.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2917.77, change: -0.05, ytd: 16.3 },
  { ticker: "VIX", name: "Volatility", value: 15.75, change: 2.81, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.47, change: 0.49, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 21.0 },
  { name: "Healthcare", color: "#34d399", return30d: 1.8 },
  { name: "Financials", color: "#fbbf24", return30d: -1.0 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 0.1 },
  { name: "Communication", color: "#a78bfa", return30d: -0.7 },
  { name: "Industrials", color: "#fb923c", return30d: -0.2 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -2.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 19.2 },
  { name: "Software", color: "#e879f9", return30d: 24.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 30.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 7.0 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -2.3 },
];
