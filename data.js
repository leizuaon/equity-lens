/*  Auto-generated by fetch_data.py — May 08, 2026 15:24
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7391.07, change: 0.74, ytd: 7.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29067.58, change: 1.76, ytd: 15.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49614.59, change: 0.04, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2850.24, change: 0.37, ytd: 13.6 },
  { ticker: "VIX", name: "Volatility", value: 17.29, change: 1.23, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.36, change: -0.77, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 22.7 },
  { name: "Healthcare", color: "#34d399", return30d: -4.1 },
  { name: "Financials", color: "#fbbf24", return30d: 0.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 9.0 },
  { name: "Communication", color: "#a78bfa", return30d: 2.7 },
  { name: "Industrials", color: "#fb923c", return30d: 2.0 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.2 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 32.4 },
  { name: "Software", color: "#e879f9", return30d: 12.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 7.0 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -3.7 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 5.7 },
];
