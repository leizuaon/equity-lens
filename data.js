/*  Auto-generated by fetch_data.py — May 01, 2026 16:58
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7244.8, change: 0.5, ytd: 5.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27719.57, change: 0.97, ytd: 10.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49610.59, change: -0.08, ytd: 2.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2803.81, change: 0.14, ytd: 11.8 },
  { ticker: "VIX", name: "Volatility", value: 16.9, change: 0.06, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.37, change: -0.46, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.9 },
  ...
  { name: "Communication", color: "#a78bfa", return30d: 5.2 },
  { name: "Industrials", color: "#fb923c", return30d: 5.4 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 3.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 29.9 },
  { name: "Software", color: "#e879f9", return30d: 8.4 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 5.8 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 11.8 },
];
