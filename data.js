/*  Auto-generated by fetch_data.py — May 18, 2026 23:03
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7403.05, change: -0.07, ytd: 7.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28994.37, change: -0.45, ytd: 15.0 },
  { ticker: "DJI", name: "Dow Jones", value: 49686.12, change: 0.32, ytd: 2.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2775.1, change: -0.65, ytd: 10.6 },
  { ticker: "VIX", name: "Volatility", value: 17.82, change: -3.31, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.62, change: 0.61, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 12.8 },
  ...
  { name: "Consumer Defensive", color: "#4ade80", return30d: 4.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 17.7 },
  { name: "Software", color: "#e879f9", return30d: 7.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -5.0 },
