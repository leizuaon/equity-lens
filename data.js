/*  Auto-generated by fetch_data.py — May 04, 2026 16:03
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7195.92, change: -0.47, ytd: 4.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27601.29, change: -0.39, ytd: 9.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49056.39, change: -0.89, ytd: 1.4 },
  { ticker: "RUT", name: "Russell 2000", value: 2799.63, change: -0.47, ytd: 11.6 },
  { ticker: "VIX", name: "Volatility", value: 18.4, change: 8.3, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.44, change: 1.42, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 18.2 },
  { name: "Healthcare", color: "#34d399", return30d: -1.1 },
  { name: "Financials", color: "#fbbf24", return30d: 3.8 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 7.9 },
  { name: "Communication", color: "#a78bfa", return30d: 4.0 },
  { name: "Industrials", color: "#fb923c", return30d: 4.1 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 27.3 },
  { name: "Software", color: "#e879f9", return30d: 9.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 5.6 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -4.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 11.2 },
];
