/*  Auto-generated by fetch_data.py — April 21, 2026 17:04
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7085.27, change: -0.34, ytd: 3.3 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26546.88, change: -0.16, ytd: 5.3 },
  { ticker: "DJI", name: "Dow Jones", value: 49329.24, change: -0.23, ytd: 2.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2779.81, change: -0.47, ytd: 10.8 },
  { ticker: "VIX", name: "Volatility", value: 19.96, change: 5.78, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.29, change: 0.99, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 13.2 },
  { name: "Healthcare", color: "#34d399", return30d: 1.0 },
  { name: "Financials", color: "#fbbf24", return30d: 6.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 8.7 },
  { name: "Communication", color: "#a78bfa", return30d: 4.7 },
  { name: "Industrials", color: "#fb923c", return30d: 5.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.0 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 18.9 },
  { name: "Software", color: "#e879f9", return30d: 3.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 3.2 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.2 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 11.3 },
];
