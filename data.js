/*  Auto-generated by fetch_data.py — May 14, 2026 21:11
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7501.24, change: 0.77, ytd: 9.4 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29580.3, change: 0.73, ytd: 17.4 },
  { ticker: "DJI", name: "Dow Jones", value: 50063.46, change: 0.75, ytd: 3.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2863.09, change: 0.67, ytd: 14.1 },
  { ticker: "VIX", name: "Volatility", value: 17.26, change: -3.41, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.46, change: -0.45, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.4 },
  ...
  { name: "Consumer Defensive", color: "#4ade80", return30d: 4.8 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 27.7 },
  { name: "Software", color: "#e879f9", return30d: 9.2 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 15.3 },
