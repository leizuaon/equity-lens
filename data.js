/*  Auto-generated by fetch_data.py — June 04, 2026 16:55
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7583.94, change: 0.4, ytd: 10.6 },
  { ticker: "NDX", name: "Nasdaq 100", value: 30431.3, change: -0.46, ytd: 20.7 },
  { ticker: "DJI", name: "Dow Jones", value: 51595.41, change: 1.79, ytd: 6.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2928.85, change: 1.22, ytd: 16.8 },
  { ticker: "VIX", name: "Volatility", value: 15.48, change: -3.61, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.47, change: -0.58, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 19.2 },
  { name: "Healthcare", color: "#34d399", return30d: 4.9 },
  { name: "Financials", color: "#fbbf24", return30d: 1.4 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -0.4 },
  { name: "Communication", color: "#a78bfa", return30d: -2.6 },
  { name: "Industrials", color: "#fb923c", return30d: 2.8 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: -1.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 23.8 },
  { name: "Software", color: "#e879f9", return30d: 12.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 22.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 7.3 },
