/*  Auto-generated by fetch_data.py — April 22, 2026 17:03
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7117.7, change: 0.76, ytd: 3.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 26833.8, change: 1.34, ytd: 6.5 },
  { ticker: "DJI", name: "Dow Jones", value: 49436.1, change: 0.58, ytd: 2.2 },
  { ticker: "RUT", name: "Russell 2000", value: 2773.42, change: 0.31, ytd: 10.6 },
  { ticker: "VIX", name: "Volatility", value: 19.42, change: -0.41, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.3, change: 0.21, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 14.8 },
  { name: "Healthcare", color: "#34d399", return30d: 1.1 },
  { name: "Financials", color: "#fbbf24", return30d: 5.9 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 21.1 },
  { name: "Software", color: "#e879f9", return30d: 4.6 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 2.8 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -2.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 10.4 },
];
