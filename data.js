/*  Auto-generated by fetch_data.py — May 25, 2026 21:08
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7473.47, change: 0.37, ytd: 9.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29481.64, change: 0.42, ytd: 17.0 },
  { ticker: "DJI", name: "Dow Jones", value: 50579.7, change: 0.58, ytd: 4.5 },
  { ticker: "RUT", name: "Russell 2000", value: 2869.23, change: 0.91, ytd: 14.4 },
  { ticker: "VIX", name: "Volatility", value: 16.59, change: -0.66, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.56, change: -0.61, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 15.8 },
  { name: "Healthcare", color: "#34d399", return30d: 2.5 },
  { name: "Financials", color: "#fbbf24", return30d: 0.3 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 1.2 },
  { name: "Communication", color: "#a78bfa", return30d: -1.6 },
  { name: "Industrials", color: "#fb923c", return30d: -1.3 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.6 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 19.6 },
  { name: "Software", color: "#e879f9", return30d: 12.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 21.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 2.9 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -3.3 },
];
