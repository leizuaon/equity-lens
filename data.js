/*  Auto-generated by fetch_data.py — May 06, 2026 16:02
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7340.7, change: 1.12, ytd: 7.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28451.29, change: 1.56, ytd: 12.9 },
  { ticker: "DJI", name: "Dow Jones", value: 49834.68, change: 1.09, ytd: 3.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2870.67, change: 0.9, ytd: 14.5 },
  { ticker: "VIX", name: "Volatility", value: 17.2, change: -1.04, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.35, change: -1.4, ytd: null },
];
...
const SECTOR_PERFORMANCE = [
  ...
  { name: "Consumer Cyclical", color: "#f87171", return30d: 9.6 },
  { name: "Communication", color: "#a78bfa", return30d: 5.0 },
  { name: "Industrials", color: "#fb923c", return30d: 7.0 },
  ...
  { name: "Cybersecurity", color: "#f472b6", return30d: 6.6 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: -1.5 },
