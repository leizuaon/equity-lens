/*  Auto-generated by fetch_data.py — June 05, 2026 19:56
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7400.1, change: -2.43, ytd: 7.9 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29057.17, change: -4.44, ytd: 15.3 },
  { ticker: "DJI", name: "Dow Jones", value: 50939.47, change: -1.21, ytd: 5.3 },
  { ticker: "RUT", name: "Russell 2000", value: 2832.33, change: -3.51, ytd: 12.9 },
  { ticker: "VIX", name: "Volatility", value: 20.44, change: 32.73, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.54, change: 1.32, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 9.2 },
  { name: "Healthcare", color: "#34d399", return30d: 5.4 },
  { name: "Financials", color: "#fbbf24", return30d: 1.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -2.6 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 9.8 },
  { name: "Software", color: "#e879f9", return30d: 8.7 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 16.2 },
