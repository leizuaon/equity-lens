/*  Auto-generated by fetch_data.py — June 08, 2026 23:12
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7405.73, change: 0.3, ytd: 8.0 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29414.26, change: 1.58, ytd: 16.7 },
  { ticker: "DJI", name: "Dow Jones", value: 50786.01, change: -0.16, ytd: 5.0 },
  { ticker: "RUT", name: "Russell 2000", value: 2855.42, change: 0.77, ytd: 13.8 },
  { ticker: "VIX", name: "Volatility", value: 18.92, change: -12.04, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.55, change: 0.35, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 3.5 },
  { name: "Healthcare", color: "#34d399", return30d: 6.7 },
  { name: "Financials", color: "#fbbf24", return30d: 1.5 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -3.3 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 3.8 },
  { name: "Software", color: "#e879f9", return30d: 5.5 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 13.4 },
