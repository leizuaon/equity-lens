/*  Auto-generated by fetch_data.py — June 11, 2026 17:37
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7347.6, change: 1.11, ytd: 7.1 },
  { ticker: "NDX", name: "Nasdaq 100", value: 29121.08, change: 2.15, ytd: 15.5 },
  { ticker: "DJI", name: "Dow Jones", value: 50628.21, change: 1.42, ytd: 4.6 },
  { ticker: "RUT", name: "Russell 2000", value: 2859.89, change: 0.86, ytd: 14.0 },
  { ticker: "VIX", name: "Volatility", value: 21.71, change: -2.3, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.53, change: -0.31, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 1.5 },
  { name: "Healthcare", color: "#34d399", return30d: 8.0 },
  { name: "Financials", color: "#fbbf24", return30d: 2.6 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -3.6 },
  ...
  { name: "Semiconductors", color: "#22d3ee", return30d: 3.4 },
  { name: "Software", color: "#e879f9", return30d: -0.0 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 12.7 },
