/*  Auto-generated by fetch_data.py — June 10, 2026 17:20
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7301.35, change: -1.15, ytd: 6.5 },
  { ticker: "NDX", name: "Nasdaq 100", value: 28600.68, change: -1.66, ytd: 13.5 },
  { ticker: "DJI", name: "Dow Jones", value: 50171.21, change: -1.38, ytd: 3.7 },
  { ticker: "RUT", name: "Russell 2000", value: 2859.64, change: -0.26, ytd: 14.0 },
  { ticker: "VIX", name: "Volatility", value: 21.58, change: 8.61, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.54, change: 0.18, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: -0.4 },
  { name: "Healthcare", color: "#34d399", return30d: 7.2 },
  { name: "Financials", color: "#fbbf24", return30d: 2.6 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: -4.6 },
  { name: "Communication", color: "#a78bfa", return30d: -3.4 },
  { name: "Industrials", color: "#fb923c", return30d: -2.4 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 2.3 },
  { name: "Semiconductors", color: "#22d3ee", return30d: -0.7 },
  { name: "Software", color: "#e879f9", return30d: 2.0 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 11.1 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 0.4 },
  { name: "Digital Payments", color: "#fcd34d", return30d: -7.7 },
];
