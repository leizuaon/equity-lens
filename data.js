/*  Auto-generated by fetch_data.py — April 29, 2026 17:43
    Source: Yahoo Finance (yfinance) — free, real-time data
    Qualitative fields (catalysts, risks, bull/bear) are hand-written */

const MARKET_INDICES = [
  { ticker: "SPX", name: "S&P 500", value: 7122.23, change: -0.23, ytd: 3.8 },
  { ticker: "NDX", name: "Nasdaq 100", value: 27078.02, change: 0.18, ytd: 7.4 },
  { ticker: "DJI", name: "Dow Jones", value: 48808.77, change: -0.68, ytd: 0.9 },
  { ticker: "RUT", name: "Russell 2000", value: 2731.61, change: -0.89, ytd: 8.9 },
  { ticker: "VIX", name: "Volatility", value: 18.75, change: 5.16, ytd: null },
  { ticker: "TNX", name: "10Y Yield", value: 4.4, change: 1.15, ytd: null },
];

const SECTOR_PERFORMANCE = [
  { name: "Technology", color: "#60a5fa", return30d: 24.0 },
  { name: "Healthcare", color: "#34d399", return30d: -0.9 },
  { name: "Financials", color: "#fbbf24", return30d: 7.2 },
  { name: "Consumer Cyclical", color: "#f87171", return30d: 10.4 },
  { name: "Communication", color: "#a78bfa", return30d: 6.8 },
  { name: "Industrials", color: "#fb923c", return30d: 8.5 },
  { name: "Consumer Defensive", color: "#4ade80", return30d: 1.4 },
  { name: "Semiconductors", color: "#22d3ee", return30d: 36.6 },
  { name: "Software", color: "#e879f9", return30d: 7.9 },
  { name: "Cybersecurity", color: "#f472b6", return30d: 10.5 },
  { name: "Aerospace & Defense", color: "#94a3b8", return30d: 1.1 },
  { name: "Digital Payments", color: "#fcd34d", return30d: 12.1 },
];
